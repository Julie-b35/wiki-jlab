...
****
C'est une connexion physique entre les noeuds réseau.

Connexion garentie par la carte réseau: 

* La carte réseau est présente sur la couche 1 & 2 du modèle OSI:
** Couche 1 : Connectique et modulation des données
** Couche 2 : Adresse Physique (MAC)
****

image::/images/cours/eni/tssr2023/base-reseau/couche-physique-2.png[couche-physique-2.png]

image::/images/cours/eni/tssr2023/base-reseau/couche-physique-3.png[couche-physique-3.png]

image::/images/cours/eni/tssr2023/base-reseau/couche-physique-4.png[couche-physique-4.png]

=== Couche de liason

****
* Adresse physique d'un noeud réseau
** Adresse MAC gérée par OUI (Organizationally Unique Identifier)
*** 48 bits hexadécimaux (6 octets)
* Contrôle d'erreur (CRC control ...)
** Cyclic Redundancy Check
** Garantir la fiabilité de la trame
****

image::/images/cours/eni/tssr2023/base-reseau/couche-liason-1.png[couche-liason-1.png]
